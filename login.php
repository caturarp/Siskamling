    ...
    <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
      ...
      <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
        <div class="right mx-lg-0 mx-auto">
          <div class="sec-logo-text mb-3">
            <img class="logo-text align-self-center" src="assets/upnLogo.png" alt="">
          </div>
          ...
          <h3 class="title-text">Masuk ke SISKAMLING
          </h3>
          <p class="caption-text">
            Gunakan akun yang kamu miliki<br />
            untuk mengakses halaman SISKAMLING
          </p>
          <form style="margin-top: 1.5rem" action="function/proseslogin.php" method="post">
            <div style="margin-bottom: 1.75rem">
              <label for="" class="d-block input-label">NPM</label>
              <div class="d-flex w-100 div-input">
                <svg class="icon" style="margin-right: 1rem" width="28" height="28" viewBox="0 0 24 24" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"
                    fill="#CACBCE" />
                </svg>
                <input class="input-field border-0" type="text" name="npm" id="" placeholder="Isikan dengan NPM"
        ...
        if(isset($_GET['pesan'])){
          if($_GET['pesan']=="gagal"){
            ...
            echo"<br>Daftar Berhasil, Silahkan login untuk mengisi formulir";
          }
        }
      ?>
          <p class="text-center bottom-caption">
            Mengalami Permasalahan Akun? <br>
            <span class="green-bottom-caption">Bantuan</span>
          </p>
        </div>
      </div>
    </div>
